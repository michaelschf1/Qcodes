...
import nidcpower
from nidcpower import OutputFunction, MeasurementTypes, MeasureWhen
...
class NiSmu(Instrument):
    def __init__(self,
        ...
        self.connection = nidcpower.Session(resource_name = resource_name,
